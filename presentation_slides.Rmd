...
- on realise une analyse factoriel sur chaque tableau

![](figures/schema_coinertia1.png) 
...
![coucou](figures/schema_coinertia2.png) 
...
- Calcule du coefficient RV entre les 2 tableaux (coefficient de correlation)
...
On fait l'Analyse Factorielle des Correspondances du tableau # de quel tableau 
```{r out.height="35%"}
...
- etape 1 : Analyse factoriel simple (ACP, ACM, AFC) `ade4::dudi.pca ou ade4::dudi.fca`

- etape 2 : verifier le poid de chaque nuage de poid `dudi.pca$lw`

- etape 3 : faire la coinerntie entre les deux plans factoriel `ade4::coinertia`

- etape 4 : tester la significativité de la coinertie : test de Monte-Carlo. `randtest(results_coinertia, nrepet=1000)`

- etape 5 : si significative, analyse de la co-inertie.
---
