...
1) La co-inertie : presentation ?

2) Un exemple : données 
...
- Les individus doivent être identiques. 
...
--
<br>
- Etape 3 : faire la co-inertie entre les deux plans factoriel `ade4::coinertia(pca1, pca2)`
