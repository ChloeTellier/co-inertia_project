...
__Attention!__ : le tableau sur lequel on effectue les permutations de ligne ne doit pas être celui qui a fourni les pondérations utilisées en analyse factorielle.
...
On crée un jeu de données qui contient, pour les mêmes 16 stations de mesure, la température à chaque heure de la journée. <br> 

On a donc 16 individus et 24 variables.

--
.center[
```{r echo=FALSE, out.height= "15%", out.extra=FALSE}
